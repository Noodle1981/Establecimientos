...
<head>
    ...
    <title>Página no Encontrada - Ministerio de Educación</title>
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 relative">
        ...
        <div class="w-full max-w-2xl text-center relative z-10">
            ...
            <div class="mb-8 relative animate-float">
                <h1 class="text-[180px] font-[900] text-orange-gradient leading-none tracking-tighter opacity-10 select-none">404</h1>
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="w-24 h-24 bg-orange-50 rounded-3xl flex items-center justify-center text-primary-orange shadow-inner border border-orange-100">
                        <i class="fas fa-search-location fa-3x"></i>
                    </div>
                </div>
            </div>

            <h2 class="text-4xl font-black text-gray-900 mb-4 uppercase tracking-tight">Extravío <span class="text-primary-orange">Digital</span></h2>
            <p class="text-gray-500 font-medium text-lg leading-relaxed mb-10 max-w-md mx-auto">
                Lo sentimos, la ruta que intentas seguir no se encuentra en nuestro mapa estratégico institucional.
            </p>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <button onclick="window.history.back()" class="px-8 py-4 glass-strong text-gray-600 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-gray-50 transition-all border border-gray-100 flex items-center gap-3">
